...
public class GlobalExceptionHandler {
    ...
    public static Result<String> resolveException(Exception ex, String path) {
        ...
        log.trace("[Kemido] |- Global Exception Handler, Path : [{}], Exception : [{}]", path, ex);

        if (ex instanceof KemidoException) {
            KemidoException exception = (KemidoException) ex;
            ...
            if (StringUtils.isNotEmpty(exceptionName) && EXCEPTION_DICTIONARY.containsKey(exceptionName)) {
                ...
                log.warn("[Kemido] |- Global Exception Handler,  Can not find the exception name [{}] in dictionary, please do optimize ", exceptionName);
            }
            ...
            log.debug("[Kemido] |- Global Exception Handler, Error is : {}", result);
            return result;
        }
    }
}
