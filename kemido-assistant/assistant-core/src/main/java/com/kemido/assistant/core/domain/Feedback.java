...
/**
 * <p>Description: KemidoException 交互信息 </p>
 * <p>
 * 主要用于自定义 KemidoException 中，显示用户体验更好的错误信息。同时可以解决更好的分包，而不再需要统一在 ResultStatus里面定义。
 * 非自定义 KemidoException 还是在 ResultErrorCodes 中定义。
 * <p>
