...
import com.kemido.assistant.core.json.jackson2.deserializer.XssStringJsonDeserializer;
...
//        objectMapper.setSerializationInclusion(JsonInclude.Include.NON_NULL);
        ...
        log.trace("[Kemido] |- Bean [Jackson Object Mapper] Auto Configure.");
        return objectMapper;
    }
    ...
    public MappingJackson2HttpMessageConverter mappingJackson2HttpMessageConverter(ObjectMapper objectMapper) {
        log.trace("[Kemido] |- Bean [Jackson Http Message Converter] Auto Configure.");
        return new MappingJackson2HttpMessageConverter(objectMapper);
    }

    @Configuration(proxyBeanMethods = false)
    @ComponentScan({
            "com.kemido.assistant.core.json.jackson2.utils"
    })
