package com.kemido.oauth2.server.resource.introspector;
 ...
 *
 */
public class KemidoOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
    ...
    public KemidoOpaqueTokenIntrospector(EndpointProperties endpointProperties, OAuth2ResourceServerProperties resourceServerProperties) {
     ...
     */
    public KemidoOpaqueTokenIntrospector(String introspectionUri, String clientId, String clientSecret) {
     ...
     */
    public KemidoOpaqueTokenIntrospector(String introspectionUri, RestOperations restOperations) {
        Assert.notNull(introspectionUri, "introspectionUri cannot be null");
    ...
    private OAuth2AuthenticatedPrincipal convertClaimsSet(Map<String, Object> claims) {
        ...
        claims.computeIfPresent(BaseConstants.AUTHORITIES, (k, v) -> {
            if (v instanceof ArrayList) {
                ...
                values.forEach(value -> authorities.add(new KemidoGrantedAuthority(value)));
            }
            return v;
        });
