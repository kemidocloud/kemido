package com.kemido.websocket.accelerator.configuration;

import com.kemido.websocket.accelerator.interceptor.WebSocketChannelInterceptor;
import com.kemido.websocket.accelerator.interceptor.WebSocketHandshakeHandler;
...
import com.kemido.websocket.accelerator.processor.WebSocketClusterProcessor;
import com.kemido.websocket.accelerator.processor.WebSocketMessageSender;
...
public class WebSocketConfiguration implements WebSocketMessageBrokerConfigurer {
    ...
    public void postConstruct() {
        log.debug("[Kemido] |- Plugin [Kemido WebSocket] Auto Configure.");
    }
    ...
    public WebSocketChannelInterceptor webSocketChannelInterceptor() {
        ...
        log.trace("[Kemido] |- Bean [Web Socket Inbound Channel Interceptor] Auto Configure.");
    ...
    public WebSocketHandshakeHandler webSocketHandshakeHandler() {
        ...
        log.trace("[Kemido] |- Bean [Web Socket Handshake Handler] Auto Configure.");
    ...
    public WebSocketMessageSender webSocketMessageSender() {
        ...
        log.trace("[Kemido] |- Bean [Web Socket Message Sender] Auto Configure.");
    ...
    public WebSocketClusterProcessor webSocketClusterProcessor(WebSocketMessageSender webSocketMessageSender) {
        ...
        log.trace("[Kemido] |- Bean [Web Socket Cluster Processor] Auto Configure.");
...
//                .setClientPasscode("password");
        ...
        // 线程名前缀
        taskScheduler.setThreadNamePrefix("kemido-websocket-heartbeat-thread-");
        // 初始化
