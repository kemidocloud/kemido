...
import com.kemido.assistant.core.constants.Sandbox;
import com.kemido.pay.core.exception.PaymentClientUninitializedException;
...
public class AlipayClientBuilder {
    ...
    private AlipayClient createByPath(boolean sandbox) {
        ...
        try {
            ...
            log.error("[Kemido] |- Alipay client uninitialized, by path!");
    ...
    private AlipayClient createByContent(boolean sandbox) {
        ...
        try {
            ...
            log.error("[Kemido] |- Alipay client uninitialized by content!");
            throw new PaymentClientUninitializedException("Alipay client uninitialized.", e.getCause());
        }
    }
