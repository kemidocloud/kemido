...
import com.kemido.captcha.behavior.dto.JigsawCaptcha;
import com.kemido.captcha.core.algorithm.GaussianBlur;
...
public class JigsawCaptchaRenderer extends AbstractBehaviorRenderer<String, Coordinate> {
    ...
    private Metadata draw(BufferedImage originalImage, BufferedImage templateImage, String sliderImageBase64) {
        ...
        log.trace("[Kemido] |- Jigsaw captcha original image width is [{}], height is [{}].", originalImageWidth, originalImageHeight);
        log.trace("[Kemido] |- Jigsaw captcha template image width is [{}], height is [{}].", templateImageWidth, templateImageHeight);
        ...
        log.trace("[Kemido] |- Jigsaw captcha jigsaw image width is [{}], height is [{}].", jigsawImage.getWidth(), jigsawImage.getHeight());
    ...
    private Coordinate createImageMattingCoordinate(int originalImageWidth, int originalImageHeight, int templateImageWidth, int templateImageHeight) {
        ...
        log.debug("[Kemido] |- Jigsaw captcha image matting coordinate is x: [{}], y: [{}].", x, y);
