 ...
 */
public class KemidoSentinelFeign {

    private KemidoSentinelFeign() {
                ...
                public InvocationHandler create(Target target,
                    ...
                    if (void.class != fallback) {
                        fallbackInstance = getFromContext(beanName, "fallback", fallback,
                                target.type());
                        return new KemidoSentinelInvocationHandler(target, dispatch,
                    ...
                    KemidoFallbackFactory kemidoFallbackFactory = new KemidoFallbackFactory(target);
                    return new KemidoSentinelInvocationHandler(target, dispatch, kemidoFallbackFactory);
                }
